                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="action text-center">
                                    ...
                                    <button type="button" class="btn btn-primary pull-right upload-zoom" id="btnZoomIn">+</button>
                                    <button type="button" class="btn btn-primary pull-right upload-zoom" id="btnZoomOut">-</button>
                                </div>
                        </div>
                    </div>
