         ...
         <div class="row">
            ...
            <div class="col-md-8 col-xs-8 text-right">
              ...
              <div class="btn-group" role="group" aria-label="First group">
                <button type="button" class="btn btn-primary menu-custom sales-menu-approved active"><i class="fa fa-list" aria-hidden="true"></i> APPROVED SALES</button>
              ...
              <button type="button" class="btn btn-primary menu-custom sales-menu-pending"><i class="fa fa-table" aria-hidden="true"></i> PENDING SALES</button>
