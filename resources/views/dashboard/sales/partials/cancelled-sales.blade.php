        <div class="SeletedMenuHeader">
         ...
         <div class="row">
            ...
            <div class="col-md-8 col-xs-8 text-right">
               ...
               <button type="button" class="btn btn-primary menu-custom sales-menu-cancelled active"><i class="fa fa-table" aria-hidden="true"></i> CANCELLED SALES</button>
