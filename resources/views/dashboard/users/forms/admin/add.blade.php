        ...
        <div class="SeletedMenuHeader">
            <div class="row">
                <div class="col-md-6 col-xs-6">
                  ...
                  <h4>
                      <a class="back agent-submenu"><img src="{{ asset('layouts/img/back.png') }}"></a>Users > Add Admin
                  </h4>
            ...
            <div class="col-md-12">
              ...
              <div class="panel">
                <div class="panel-body page-content">
                    ...
                    <div class="AddAdminSteps steps-con">
                        ...
                        <section>
                          ...
                          <form action="/users/admin/add" method="POST" id="AddAdminForm">
                          {{ csrf_field() }}
