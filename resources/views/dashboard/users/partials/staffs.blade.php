        <div class="SeletedMenuHeader">
         ...
         <div class="row">
            <div class="col-md-4 col-xs-4">
              <h4>Users <i class="fa fa-angle-right"></i> Staff</h4>
            </div>
            ...
            <div class="col-md-8 col-xs-8 text-right">
                ...
                <div class="btn-group" role="group" aria-label="First group">
                 ...
                 @endif
                  ...
                  @if( ( $auth->role == "Admin") ||  ( $auth->role == "SuperAdmin") )
                     <button type="button" class="btn btn-primary menu-custom staff-submenu active">STAFF LIST</button>
                  @endif
                </div>
              ...
              <button type="button" class="btn btn-primary"  id="AddStaffBtn">
                <img src="{{ asset('layouts/img/add-user.png') }}"> Add Staff
              </button>
            </div>
         </div>
